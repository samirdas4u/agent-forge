            ...
            <>
              ...
              {isLoading ? (
                ...
                <div className="rounded-2xl bg-[#111318] border border-white/[0.06] overflow-hidden">
                  {/* Table header */}
                  <div className="grid grid-cols-[auto_1fr_auto_auto] gap-4 px-4 py-2.5 border-b border-white/[0.06] bg-white/[0.02]">
                  ...
                  <div className="divide-y divide-white/[0.04]">
                    {filteredEvents.map((event: any) => {
                      ...
                      return (
                        <div key={event.id}>
                          <div
                            className="grid grid-cols-[auto_1fr_auto_auto] gap-4 px-4 py-3 hover:bg-white/[0.02] cursor-pointer transition-colors items-center"
